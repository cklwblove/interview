...
// 根据不同命令动态生成router.config，相当于把dynamic/里的配置文件拷贝到router.config文件中
fs.createReadStream(utils.resolve(`src/modules/router/dynamic/${process.env.BROWSER_PROJECT}.js`)).pipe(fs.createWriteStream(utils.resolve('src/modules/router/router.config.js')))
